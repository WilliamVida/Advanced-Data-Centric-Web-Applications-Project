...
public class OrderService {
	...
	public void save(Order o)
			throws OrderQuantityException, CustomerDoesNotExistException, ProductDoesNotExistException {
		...
		// the error where a customer or product has been manually removed does not work
		if (o.getQty() > p.getQtyInStock()) {
			...
			throw new CustomerDoesNotExistException("ERROR: Customer: " + o.getCust().getcId() + " and/or Product"
					+ o.getProd().getpId() + " does not exist");
		} else if (o.getProd().getpId() == null) {
			throw new ProductDoesNotExistException("ERROR: Customer: " + o.getCust().getcId() + " and/or Product"
					+ o.getProd().getpId() + " does not exist");
		} else {
